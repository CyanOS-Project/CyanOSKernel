...
#define PAGE_FLAGS_PRESENT       MASKABLE_PRAM(0)
#define PAGE_FLAGS_WRITABLE      MASKABLE_PRAM(1)
#define PAGE_FLAGS_USER          MASKABLE_PRAM(2)
#define PAGE_FLAGS_WRITE_THOUGH  MASKABLE_PRAM(3)
#define PAGE_FLAGS_CACHE_DISABLE MASKABLE_PRAM(4)
#define PAGE_FLAGS_ACCESSED      MASKABLE_PRAM(5)
#define PAGE_FLAGS_DIRTY         MASKABLE_PRAM(6)
